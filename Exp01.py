...
def experiment(dataset_name):
    ...
    if dataset_name == 'AGNews':
        ...
        output_size = 2
    vocab_size, train_loader, val_loader, test_loader = load_data.load_dataset(dataset_name)
    ...
    for model, path in zip(model_list, model_path):
        ...
        training(model, n_epochs, criterion, optimizer, device, path, train_loader, val_loader)
        counter += 1
